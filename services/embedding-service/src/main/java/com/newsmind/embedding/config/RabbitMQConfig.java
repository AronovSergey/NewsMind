package com.newsmind.embedding.config;
...
public class RabbitMQConfig {
    ...
    public static final String NEWS_FETCHED_QUEUE = "news.fetched.embedding.queue";
    public static final String NEWS_FETCHED_DLQ = "news.fetched.embedding.dlq";

    public static final String NEWS_EMBEDDED_EXCHANGE = "news.embedded";
    ...
    @Bean
    public FanoutExchange newsEmbeddedExchange() {
        return new FanoutExchange(NEWS_EMBEDDED_EXCHANGE, true, false);
    }
