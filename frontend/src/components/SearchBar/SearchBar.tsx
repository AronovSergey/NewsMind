    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className={`flex items-center gap-3 bg-white dark:bg-zinc-900 rounded-2xl border shadow-sm px-4 py-3 transition-all duration-200
                      ${loading
                        ...
                        : 'border-gray-200 dark:border-zinc-800 focus-within:border-purple-400 dark:focus-within:border-purple-500 focus-within:shadow-lg focus-within:shadow-purple-100/60 dark:focus-within:shadow-purple-900/30'}`}>
