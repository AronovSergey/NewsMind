      ...
      <div className="w-full px-4 sm:px-8 flex flex-col items-center gap-2">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-5">
          ...
          <a
            ...
            className="flex items-center gap-1.5 text-xs text-gray-400 dark:text-zinc-500 hover:text-purple-600 dark:hover:text-purple-400 transition-colors"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-xs text-gray-400 dark:text-zinc-500 hover:text-gray-800 dark:hover:text-zinc-200 transition-colors"
          >
            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
